...
if __name__ == "__main__":
    ...
    p_dict = {
        ...
        "state_data": "run_velde_slow_week_bak.npz",
        ...
        "dt_max": Q_("3600 seconds").to("seconds").magnitude,  # time step in years
        "dt_target_change": 0.0001,  # target change per step (for dt adaptation)
